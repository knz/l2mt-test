/*
	...
	Copyright (C) 2016,2017 Raphael 'kena' Poss
        ...
        euclide1-pllsf-1d is free software: you can redistribute it and/or modify
...
#define BLOCKSIZE 30
    ...
    sl_create(,,,STRIPES_PER_FRAME,,BLOCKSIZE,, progressiveLinearLeastSquaresFit,
    ...
    report_perf(FRAME_RATIO, b, "progressiveLinearLeastSquaresFit", delta(c2,c1), delta(i2,i1));
    return 0;
}
